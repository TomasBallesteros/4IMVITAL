...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["new_user" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["new_user" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["retrieve_pswd" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["retrieve_pswd" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_new_user' + iSeqRow).bind('blur', function() { sc_app_Login_new_user_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_app_Login_new_user_onfocus(this, iSeqRow) });
  $('#id_sc_field_retrieve_pswd' + iSeqRow).bind('blur', function() { sc_app_Login_retrieve_pswd_onblur(this, iSeqRow) })
