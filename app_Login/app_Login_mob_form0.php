...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "); } else { echo strip_tags("4Imvital"); } ?></TITLE>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>app_Login/app_Login_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['last'] : 'off'); ?>";
...
else
{
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['link_info']['remove_border']) {
...
<?php echo "</div>\r\n"; ?></span><?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_remember_me_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_remember_me_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<input type="hidden" name="new_user_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_new_user('app_form_add_users', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_new_user'] ?></a>
<?php  } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_new_user_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_new_user_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<input type="hidden" name="retrieve_pswd_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_retrieve_pswd('app_retrieve_pswd', '_self')" class="scFormLinkOdd"><?php echo $this->Ini->Nm_lang['lang_subject_mail'] ?></a>
<?php  } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_retrieve_pswd_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_retrieve_pswd_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<table style="border-collapse: collapse; border-width: 0px">
 <tr>
  <td><span class="scFormPageText"></span></td>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['app_Login_mob']['btn_label']['ok'];
        }
?>
