...
$_SESSION['scriptcase']['app_form_add_users_mob']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['app_form_add_users_mob']['upload_field_info']['picture'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'app_form_add_users_mob',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users_mob']['label'] = "" . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->NM_ajax_info['param']['picture_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      elseif (isset($this->picture_ul_name) && '' != $this->picture_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->picture_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['upload_field_ul_name'][$this->picture_ul_name];
          }
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'app_form_add_users_mob_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dados_form']['picture']) && $this->picture_limpa != "S")
          {
              $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['dados_form']['picture'];
          }
      } 
   }
...
//---------- 
      ...
      { 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['parms'] = "login?#?$this->login?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users_mob']['sub_dir'][0]  = "";
          } 
