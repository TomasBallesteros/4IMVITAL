...
$_SESSION['scriptcase']['app_form_add_users']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['app_form_add_users']['upload_field_info']['picture'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'app_form_add_users',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['app_form_add_users']['label'] = "" . $this->Ini->Nm_lang['lang_list_users'] . "";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->NM_ajax_info['param']['picture_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['upload_field_ul_name'][$this->picture_ul_name];
          }
      ...
      elseif (isset($this->picture_ul_name) && '' != $this->picture_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['upload_field_ul_name'][$this->picture_ul_name]))
          {
              $this->picture_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['upload_field_ul_name'][$this->picture_ul_name];
          }
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'app_form_add_users_doc_name.php';
              }
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dados_form']['picture']) && $this->picture_limpa != "S")
          {
              $this->picture = $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['dados_form']['picture'];
          }
      } 
   }
...
//---------- 
      ...
      { 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['parms'] = "login?#?$this->login?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_add_users']['sub_dir'][0]  = "";
          } 
