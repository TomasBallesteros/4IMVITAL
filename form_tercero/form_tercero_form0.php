...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_tercero/form_tercero_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_tercero_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_tercero_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['link_info']['remove_border']) {
...
<?php
 include_once("form_tercero_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tercero'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tercero'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['te_tidentificacion'] = (isset($this->nm_new_label['te_tidentificacion'])) ? $this->nm_new_label['te_tidentificacion'] : 'TIPO IDENTIFICACION'; 
          $SC_Label_atu['te_identificacion'] = (isset($this->nm_new_label['te_identificacion'])) ? $this->nm_new_label['te_identificacion'] : 'IDENTIFICACION'; 
          $SC_Label_atu['te_nombres'] = (isset($this->nm_new_label['te_nombres'])) ? $this->nm_new_label['te_nombres'] : 'NOMBRES'; 
          $SC_Label_atu['te_apellidos'] = (isset($this->nm_new_label['te_apellidos'])) ? $this->nm_new_label['te_apellidos'] : 'APELLIDOS'; 
          $SC_Label_atu['te_direccion'] = (isset($this->nm_new_label['te_direccion'])) ? $this->nm_new_label['te_direccion'] : 'DIRECCIÓN'; 
          $SC_Label_atu['te_telefono'] = (isset($this->nm_new_label['te_telefono'])) ? $this->nm_new_label['te_telefono'] : 'TELÉFONO'; 
          $SC_Label_atu['te_departamento'] = (isset($this->nm_new_label['te_departamento'])) ? $this->nm_new_label['te_departamento'] : 'DEPARTAMENTO'; 
          $SC_Label_atu['te_municipio'] = (isset($this->nm_new_label['te_municipio'])) ? $this->nm_new_label['te_municipio'] : 'MUNICIPIO'; 
          $SC_Label_atu['te_gsangre'] = (isset($this->nm_new_label['te_gsangre'])) ? $this->nm_new_label['te_gsangre'] : 'GRUPO SANGUINEO'; 
          $SC_Label_atu['te_rhsangre'] = (isset($this->nm_new_label['te_rhsangre'])) ? $this->nm_new_label['te_rhsangre'] : 'FACTOR RH'; 
          $SC_Label_atu['te_eps'] = (isset($this->nm_new_label['te_eps'])) ? $this->nm_new_label['te_eps'] : 'EPS'; 
          $SC_Label_atu['te_regimen'] = (isset($this->nm_new_label['te_regimen'])) ? $this->nm_new_label['te_regimen'] : 'RÉGIMEN'; 
          $SC_Label_atu['te_fnacimiento'] = (isset($this->nm_new_label['te_fnacimiento'])) ? $this->nm_new_label['te_fnacimiento'] : 'FECHA NACIMIENTO'; 
          $SC_Label_atu['te_nombre_contacto'] = (isset($this->nm_new_label['te_nombre_contacto'])) ? $this->nm_new_label['te_nombre_contacto'] : 'NOMBRES'; 
          $SC_Label_atu['te_telefono_contacto'] = (isset($this->nm_new_label['te_telefono_contacto'])) ? $this->nm_new_label['te_telefono_contacto'] : 'TELÉFONO'; 
          $SC_Label_atu['te_departamento_contacto'] = (isset($this->nm_new_label['te_departamento_contacto'])) ? $this->nm_new_label['te_departamento_contacto'] : 'DEPARTAMENTO'; 
          $SC_Label_atu['te_municipio_contacto'] = (isset($this->nm_new_label['te_municipio_contacto'])) ? $this->nm_new_label['te_municipio_contacto'] : 'MUNICIPIO'; 
          $SC_Label_atu['te_direccion_contacto'] = (isset($this->nm_new_label['te_direccion_contacto'])) ? $this->nm_new_label['te_direccion_contacto'] : 'DIRECCIÓN'; 
          $SC_Label_atu['te_parentesco_contacto'] = (isset($this->nm_new_label['te_parentesco_contacto'])) ? $this->nm_new_label['te_parentesco_contacto'] : 'PARENTESCO'; 
          $SC_Label_atu['te_foto'] = (isset($this->nm_new_label['te_foto'])) ? $this->nm_new_label['te_foto'] : 'FOTO'; 
          $SC_Label_atu['te_antecedentes'] = (isset($this->nm_new_label['te_antecedentes'])) ? $this->nm_new_label['te_antecedentes'] : 'ANTECEDENTES'; 
          $SC_Label_atu['te_autoriza'] = (isset($this->nm_new_label['te_autoriza'])) ? $this->nm_new_label['te_autoriza'] : ''; 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['breload']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['breload']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['breload']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['breload']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['breload'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_te_tidentificacion_dumb = ('' == $sStyleHidden_te_tidentificacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_tidentificacion_dumb" style="<?php echo $sStyleHidden_te_tidentificacion_dumb; ?>"></TD>
<?php $sStyleHidden_te_identificacion_dumb = ('' == $sStyleHidden_te_identificacion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_identificacion_dumb" style="<?php echo $sStyleHidden_te_identificacion_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_te_nombres_dumb = ('' == $sStyleHidden_te_nombres) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_nombres_dumb" style="<?php echo $sStyleHidden_te_nombres_dumb; ?>"></TD>
<?php $sStyleHidden_te_apellidos_dumb = ('' == $sStyleHidden_te_apellidos) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_apellidos_dumb" style="<?php echo $sStyleHidden_te_apellidos_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_te_direccion_dumb = ('' == $sStyleHidden_te_direccion) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_direccion_dumb" style="<?php echo $sStyleHidden_te_direccion_dumb; ?>"></TD>
<?php $sStyleHidden_te_telefono_dumb = ('' == $sStyleHidden_te_telefono) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_telefono_dumb" style="<?php echo $sStyleHidden_te_telefono_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_te_departamento_dumb = ('' == $sStyleHidden_te_departamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_departamento_dumb" style="<?php echo $sStyleHidden_te_departamento_dumb; ?>"></TD>
<?php $sStyleHidden_te_municipio_dumb = ('' == $sStyleHidden_te_municipio) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_municipio_dumb" style="<?php echo $sStyleHidden_te_municipio_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_gsangre'][] = 'A'; ?>
 <option  value="B" <?php  if ($this->te_gsangre == "B") { echo " selected" ;} ?>>B</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_gsangre'][] = 'B'; ?>
 <option  value="AB" <?php  if ($this->te_gsangre == "AB") { echo " selected" ;} ?>>AB</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_gsangre'][] = 'AB'; ?>
 <option  value="O" <?php  if ($this->te_gsangre == "O") { echo " selected" ;} ?>>O</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_gsangre'][] = 'O'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_rhsangre'][] = '+'; ?>
 <option  value="-" <?php  if ($this->te_rhsangre == "-") { echo " selected" ;} ?>>-</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_rhsangre'][] = '-'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_te_gsangre_dumb = ('' == $sStyleHidden_te_gsangre) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_gsangre_dumb" style="<?php echo $sStyleHidden_te_gsangre_dumb; ?>"></TD>
<?php $sStyleHidden_te_rhsangre_dumb = ('' == $sStyleHidden_te_rhsangre) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_rhsangre_dumb" style="<?php echo $sStyleHidden_te_rhsangre_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_regimen'][] = 'SUBSIDIADO'; ?>
 <option  value="CONTRIBUTIVO" <?php  if ($this->te_regimen == "CONTRIBUTIVO") { echo " selected" ;} ?>>CONTRIBUTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_regimen'][] = 'CONTRIBUTIVO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_te_eps_dumb = ('' == $sStyleHidden_te_eps) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_eps_dumb" style="<?php echo $sStyleHidden_te_eps_dumb; ?>"></TD>
<?php $sStyleHidden_te_regimen_dumb = ('' == $sStyleHidden_te_regimen) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_regimen_dumb" style="<?php echo $sStyleHidden_te_regimen_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_te_nombre_contacto_dumb = ('' == $sStyleHidden_te_nombre_contacto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_nombre_contacto_dumb" style="<?php echo $sStyleHidden_te_nombre_contacto_dumb; ?>"></TD>
<?php $sStyleHidden_te_telefono_contacto_dumb = ('' == $sStyleHidden_te_telefono_contacto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_telefono_contacto_dumb" style="<?php echo $sStyleHidden_te_telefono_contacto_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } 
?> 
<?php $sStyleHidden_te_departamento_contacto_dumb = ('' == $sStyleHidden_te_departamento_contacto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_departamento_contacto_dumb" style="<?php echo $sStyleHidden_te_departamento_contacto_dumb; ?>"></TD>
<?php $sStyleHidden_te_municipio_contacto_dumb = ('' == $sStyleHidden_te_municipio_contacto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_municipio_contacto_dumb" style="<?php echo $sStyleHidden_te_municipio_contacto_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_te_direccion_contacto_dumb = ('' == $sStyleHidden_te_direccion_contacto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_te_direccion_contacto_dumb" style="<?php echo $sStyleHidden_te_direccion_contacto_dumb; ?>"></TD>
...
<div id="id_sc_dragdrop_te_foto" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_te_foto ?>"><i class='fas fa-cloud-upload-alt'></i><br/>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['Lookup_te_autoriza'][] = 'SI'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tercero");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tercero");
 parent.scAjaxDetailHeight("form_tercero", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_tercero']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
