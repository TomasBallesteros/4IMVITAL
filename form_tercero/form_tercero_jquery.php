...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_te_id' + iSeqRow).bind('change', function() { sc_form_tercero_te_id_onchange(this, iSeqRow) });
  $('#id_sc_field_te_tidentificacion' + iSeqRow).bind('blur', function() { sc_form_tercero_te_tidentificacion_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_tercero_te_tidentificacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_identificacion' + iSeqRow).bind('blur', function() { sc_form_tercero_te_identificacion_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_tercero_te_identificacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_nombres' + iSeqRow).bind('blur', function() { sc_form_tercero_te_nombres_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_tercero_te_nombres_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_apellidos' + iSeqRow).bind('blur', function() { sc_form_tercero_te_apellidos_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tercero_te_apellidos_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_direccion' + iSeqRow).bind('blur', function() { sc_form_tercero_te_direccion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tercero_te_direccion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_telefono' + iSeqRow).bind('blur', function() { sc_form_tercero_te_telefono_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_tercero_te_telefono_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_municipio' + iSeqRow).bind('blur', function() { sc_form_tercero_te_municipio_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_tercero_te_municipio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_gsangre' + iSeqRow).bind('blur', function() { sc_form_tercero_te_gsangre_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_tercero_te_gsangre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_rhsangre' + iSeqRow).bind('blur', function() { sc_form_tercero_te_rhsangre_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_tercero_te_rhsangre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_fnacimiento' + iSeqRow).bind('blur', function() { sc_form_tercero_te_fnacimiento_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_tercero_te_fnacimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_regimen' + iSeqRow).bind('blur', function() { sc_form_tercero_te_regimen_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_tercero_te_regimen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_eps' + iSeqRow).bind('blur', function() { sc_form_tercero_te_eps_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_tercero_te_eps_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_foto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_foto_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_tercero_te_foto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_autoriza' + iSeqRow).bind('blur', function() { sc_form_tercero_te_autoriza_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_tercero_te_autoriza_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_nombre_contacto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_nombre_contacto_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_tercero_te_nombre_contacto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_telefono_contacto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_telefono_contacto_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_tercero_te_telefono_contacto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_municipio_contacto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_municipio_contacto_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_tercero_te_municipio_contacto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_direccion_contacto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_direccion_contacto_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_tercero_te_direccion_contacto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_parentesco_contacto' + iSeqRow).bind('blur', function() { sc_form_tercero_te_parentesco_contacto_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_form_tercero_te_parentesco_contacto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_te_antecedentes' + iSeqRow).bind('blur', function() { sc_form_tercero_te_antecedentes_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_tercero_te_antecedentes_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_tercero_te_antecedentes_onfocus(this, iSeqRow) });
  $('#id_sc_field_te_codigo' + iSeqRow).bind('change', function() { sc_form_tercero_te_codigo_onchange(this, iSeqRow) });
  $('.sc-ui-checkbox-te_autoriza' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_tercero_te_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_tidentificacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_identificacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_nombres_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_apellidos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_telefono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_municipio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_gsangre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_rhsangre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_fnacimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_regimen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_eps_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_foto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_autoriza_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_nombre_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_telefono_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_municipio_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_direccion_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_parentesco_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_antecedentes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_tercero_te_codigo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_tercero_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_te_fnacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      setTimeout(function() { do_ajax_form_tercero_validate_te_fnacimiento(iSeqRow); }, 200);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_te_foto" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_tercero_ul_save.php",
    dropZone: $("#hidden_field_data_te_foto" + iSeqRow),
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_tercero')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
