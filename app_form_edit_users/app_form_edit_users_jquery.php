...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_active' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_active_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_app_form_edit_users_active_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_priv_admin' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_priv_admin_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_app_form_edit_users_priv_admin_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_app_form_edit_users_priv_admin_onfocus(this, iSeqRow) });
  $('#id_sc_field_mfa' + iSeqRow).bind('change', function() { sc_app_form_edit_users_mfa_onchange(this, iSeqRow) });
  $('#id_sc_field_picture' + iSeqRow).bind('blur', function() { sc_app_form_edit_users_picture_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_app_form_edit_users_picture_onchange(this, iSeqRow) })
  ...
  $('.sc-ui-checkbox-priv_admin' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd
...
function sc_app_form_edit_users_active_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_app_form_edit_users_mfa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_app_form_edit_users_picture_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_picture" + iSeqRow).fileupload({
    datatype: "json",
    url: "app_form_edit_users_ul_save.php",
