      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
             ...
             { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('picture', 'login', 'pswd', 'confirm_pswd', 'name', 'email', 'active', 'priv_admin'), $aDoNotUpdate);
              $this->ajax_return_values();
...
//---------- 
      ...
      { 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['parms'] = "login?#?$this->login?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['app_form_edit_users_mob']['sub_dir'][0]  = "";
          } 
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "first":
                return array("sc_b_ini_t.sc-unique-btn-1", "sc_b_ini_t.sc-unique-btn-15");
                break;
            case "back":
                return array("sc_b_ret_t.sc-unique-btn-2", "sc_b_ret_t.sc-unique-btn-16");
                break;
            case "forward":
                return array("sc_b_avc_t.sc-unique-btn-3", "sc_b_avc_t.sc-unique-btn-17");
                break;
            case "last":
                return array("sc_b_fim_t.sc-unique-btn-4", "sc_b_fim_t.sc-unique-btn-18");
                break;
            case "new":
                return array("sc_b_new_b.sc-unique-btn-5", "sc_b_new_b.sc-unique-btn-19");
                break;
            case "insert":
                return array("sc_b_ins_b.sc-unique-btn-6", "sc_b_ins_b.sc-unique-btn-20");
                break;
            case "bcancelar":
                return array("sc_b_sai_b.sc-unique-btn-7", "sc_b_sai_b.sc-unique-btn-21");
                break;
            case "update":
                return array("sc_b_upd_b.sc-unique-btn-8", "sc_b_upd_b.sc-unique-btn-22");
                break;
            case "delete":
                return array("sc_b_del_b.sc-unique-btn-9", "sc_b_del_b.sc-unique-btn-23");
                break;
            case "help":
                return array("sc_b_hlp_b");
                break;
            case "exit":
                return array("sc_b_sai_b.sc-unique-btn-10", "sc_b_sai_b.sc-unique-btn-11", "sc_b_sai_b.sc-unique-btn-13", "sc_b_sai_b.sc-unique-btn-24", "sc_b_sai_b.sc-unique-btn-25", "sc_b_sai_b.sc-unique-btn-27", "sc_b_sai_b.sc-unique-btn-12", "sc_b_sai_b.sc-unique-btn-14", "sc_b_sai_b.sc-unique-btn-26", "sc_b_sai_b.sc-unique-btn-28");
                break;
        }
