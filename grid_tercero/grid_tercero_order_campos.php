...
<?php
   ...
   $Ord_Cmp = new grid_tercero_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tercero_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['te_tidentificacion'] = "TE_TIDENTIFICACION";
   $tab_labels["te_tidentificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_tidentificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_tidentificacion"] : "TIPO IDENTIFICACIÓN";
   $tab_ger_campos['te_identificacion'] = "on";
   $tab_def_campos['te_identificacion'] = "TE_IDENTIFICACION";
   $tab_labels["te_identificacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_identificacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_identificacion"] : "IDENTIFICACIÓN";
   $tab_ger_campos['te_nombres'] = "on";
   $tab_def_campos['te_nombres'] = "TE_NOMBRES";
   $tab_labels["te_nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_nombres"] : "NOMBRES";
   $tab_ger_campos['te_apellidos'] = "on";
   $tab_def_campos['te_apellidos'] = "TE_APELLIDOS";
   $tab_labels["te_apellidos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_apellidos"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_apellidos"] : "APELLIDOS";
   $tab_ger_campos['te_telefono'] = "on";
   $tab_def_campos['te_telefono'] = "TE_TELEFONO";
   $tab_labels["te_telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_telefono"] : "TELÉFONO";
   $tab_ger_campos['te_fnacimiento'] = "on";
   $tab_def_campos['te_fnacimiento'] = "TE_FNACIMIENTO";
   $tab_labels["te_fnacimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_fnacimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["te_fnacimiento"] : "FECHA NACIMIENTO";
   $tab_ger_campos['antecedentes'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['antecedentes'] = "ANTECEDENTES";
   }
   else
   {
       $tab_def_campos['antecedentes'] = "";
   }
   $tab_labels["antecedentes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["antecedentes"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["antecedentes"] : "VER ANTECEDENTES";
   ...
   $tab_labels["qr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["qr"])) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['labels']["qr"] : "VER QR";
   $tab_ger_campos['antecedentes'] = "none";
   $tab_ger_campos['qr'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tercero']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tercero']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tercero_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tercero']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
