<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tercero']['sc_process_barr'] = true;
require_once('../grid_tercero/index.php');
unset($_SESSION['scriptcase']['grid_tercero']['sc_process_barr']);
$ExportCtrl = new grid_tercero_export_control;
$ExportCtrl->Export_barr();

class grid_tercero_export_control
{
