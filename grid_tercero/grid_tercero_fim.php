...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Imvital_____grid_tercero"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Imvital_____grid_tercero"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tercero'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tercero']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tercero']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tercero']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tercero']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tercero']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tercero']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tercero']['embutida_filho'] as $ind => $sc_init)
          {
