...
//----- 
   ...
   { 
       $nmgp_select = "SELECT picture, login, name, email, active, priv_admin from " . $this->Ini->nm_tabela; 
   } 
   else 
   { 
       $nmgp_select = "SELECT picture, login, name, email, active, priv_admin from " . $this->Ini->nm_tabela; 
   ...
   { 
       ...
       $this->priv_admin = $this->rs_grid->fields[5] ;  
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida']) {  
 ...
 function NM_label_priv_admin()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_priv_admin_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_priv_admin_label'] . "\" >\r\n");
    ...
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != 'print' && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != 'pdf') {
        // label & order
        $divLabelStyle = '';
        $fieldSortRule = $this->scGetColumnOrderRule('priv_admin');
        $fieldSortIcon = $this->scGetColumnOrderIcon('priv_admin', $fieldSortRule);
        if (empty($this->Ini->Label_sort_pos) || $this->Ini->Label_sort_pos == 'right') {
            $this->Ini->Label_sort_pos = 'right_field';
        }
        if (empty($fieldSortIcon)) {
        ...
        $label_labelContent = "<a href=\"javascript:nm_gp_submit2('priv_admin')\" class=\"" . $this->css_scGridLabelLink . "\">". $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        // controls
        $label_chart = '';
        $label_fixedColumn = '';
...
// 
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['mostra_edit'] != "N"){ 
              ...
              $Link_Edit = nmButtonOutput($this->arr_buttons, "bform_editar", "NM_ancor_ult_lig=" . $this->SC_ancora . ";nm_submit_modal('" . $this->Ini->link_app_form_edit_users . "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&nmgp_opcao=igual&nmgp_parms=" . $Md5_Edt . "&KeepThis=true&TB_iframe=true&height=500&width=550&modal=true', '" . $Sc_parent . "')", "NM_ancor_ult_lig=" . $this->SC_ancora . ";nm_submit_modal('" . $this->Ini->link_app_form_edit_users . "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&nmgp_opcao=igual&nmgp_parms=" . $Md5_Edt . "&KeepThis=true&TB_iframe=true&height=500&width=550&modal=true', '" . $Sc_parent . "')", "bedit", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              ...
              if ($_SESSION['scriptcase']['proc_mobile']) {
                  $Link_Det  = nmButtonOutput($this->arr_buttons, "bcons_detalhes", "nm_submit_modal('" . $this->Ini->path_link . "app_grid_sec_users/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=app_grid_sec_users&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "nm_submit_modal('" . $this->Ini->path_link . "app_grid_sec_users/index.php?nmgp_parms=" . $Md5_Det . "&nmgp_parm_acum=&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&SC_lig_apl_orig=app_grid_sec_users&nmgp_opcao=detalhe&KeepThis=true&TB_iframe=true&height=440&width=630&modal=true', '" . $Sc_parent . "')", "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              }
 ...
 function NM_grid_picture()
 {
      ...
      if (!isset($this->NM_cmp_hidden['picture']) || $this->NM_cmp_hidden['picture'] != "off") { 
          ...
          $conteudo_original = $this->picture; 
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
                  $conteudo = "<img border=\"0\" src=\"data:image/jpeg;base64," . base64_encode($reg_picture) . "\"/>" ; 
              } 
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['app_grid_sec_users']['embutida_pdf'] != "pdf") 
              { 
 ...
 function NM_grid_priv_admin()
 {
      ...
      if (!isset($this->NM_cmp_hidden['priv_admin']) || $this->NM_cmp_hidden['priv_admin'] != "off") { 
          ...
          $conteudo_original = trim(sc_strip_script($this->look_priv_admin)); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
