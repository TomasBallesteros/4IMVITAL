...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'Imvital', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_settings']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_settings']['glo_nm_conexao'], $this->root . $this->path_prod, 'Imvital', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_SESSION['scriptcase']['app_settings']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['app_settings']['session_timeout']['lang'];
    }
    ...
    else
    {
        ...
        if (empty($_SESSION['sc_session'][$script_case_init]['app_settings']['volta_tp']) && $_SESSION['sc_session'][$script_case_init]['app_settings']['run_iframe'] != "F" && $_SESSION['sc_session'][$script_case_init]['app_settings']['run_iframe'] != "R")
        {
            ...
            $_SESSION['sc_session'][$script_case_init]['app_settings']['volta_dep'] = $nm_apl_dependente;
        ...
        $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['app_settings']['volta_php'];
        $nm_saida_global = $_SESSION['sc_session'][$script_case_init]['app_settings']['volta_php'];
        $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['app_settings']['volta_dep'];
    ...
    if (!isset($_SESSION['scriptcase']['app_settings']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_settings']) || $_SESSION['scriptcase']['sc_apl_seg']['app_settings'] != "on"))
    { 
        $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['app_settings']['iframe_menu']) ? false : true;
...
//-----
      {
         ...
         {
            $inicial_app_settings->contr_app_settings->NM_ajax_info['buttonDisplay'] = $inicial_app_settings->contr_app_settings->nmgp_botoes;
