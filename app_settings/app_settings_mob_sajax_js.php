...
?>
  ...
  function do_ajax_app_settings_mob_event_enable_2fa_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_app_settings_mob_event_enable_2fa_onclick(var_enable_2fa, var_enable_2fa_expiration_time, var_script_case_init, do_ajax_app_settings_mob_event_enable_2fa_onclick_cb);
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_app_settings_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_app_settings_mob_submit_form(var_session_expire, var_remember_me, var_cookie_expiration_time, var_retrieve_password, var_new_users, var_brute_force, var_brute_force_time_block, var_brute_force_attempts, var_enable_2fa, var_enable_2fa_expiration_time, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_app_settings_mob_submit_form_cb);
