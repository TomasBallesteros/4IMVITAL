...
$old_error_handler = set_error_handler("ver_antecedentes_scriptcase_error_handler");

function ver_antecedentes_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ver_antecedentes']['contr_erro']) && $_SESSION['scriptcase']['ver_antecedentes']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ver_antecedentes->contr_ver_antecedentes->Apl_com_erro = true;
            if ($inicial_ver_antecedentes->contr_ver_antecedentes->NM_ajax_flag)
            {
                $inicial_ver_antecedentes->contr_ver_antecedentes->NM_ajax_info['errList']['geral_ver_antecedentes'][] = $msg;
                return;
            }
            ver_antecedentes_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ver_antecedentes_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ver_antecedentes'])  && '' != $_SESSION['scriptcase']['error_icon']['ver_antecedentes'])  ? $_SESSION['scriptcase']['error_icon']['ver_antecedentes']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['ver_antecedentes']) && '' != $_SESSION['scriptcase']['error_close']['ver_antecedentes']) ? $_SESSION['scriptcase']['error_close']['ver_antecedentes'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ver_antecedentes']) && '' != $_SESSION['scriptcase']['error_span_title']['ver_antecedentes']) ? $_SESSION['scriptcase']['error_span_title']['ver_antecedentes'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ver_antecedentes']) && '' != $_SESSION['scriptcase']['error_icon_title']['ver_antecedentes']) ? $_SESSION['scriptcase']['error_icon_title']['ver_antecedentes'] : '';
?>
