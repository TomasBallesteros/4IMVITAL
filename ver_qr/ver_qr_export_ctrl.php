<?php
@session_start() ;
$_SESSION['scriptcase']['ver_qr']['sc_process_barr'] = true;
require_once('../ver_qr/index.php');
unset($_SESSION['scriptcase']['ver_qr']['sc_process_barr']);
$ExportCtrl = new ver_qr_export_control;
$ExportCtrl->Export_barr();

class ver_qr_export_control
{
