  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_ver_tercero_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate logo
  function do_ajax_ver_tercero_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_logo(var_logo, var_script_case_init, do_ajax_ver_tercero_mob_validate_logo_cb);
  } // do_ajax_ver_tercero_mob_validate_logo

  function do_ajax_ver_tercero_mob_validate_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_logo_cb

  // ---------- Validate nombres
  function do_ajax_ver_tercero_mob_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_nombres(var_nombres, var_script_case_init, do_ajax_ver_tercero_mob_validate_nombres_cb);
  } // do_ajax_ver_tercero_mob_validate_nombres

  function do_ajax_ver_tercero_mob_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_nombres_cb

  // ---------- Validate cedula
  function do_ajax_ver_tercero_mob_validate_cedula()
  {
    var nomeCampo_cedula = "cedula";
    var var_cedula = scAjaxGetFieldText(nomeCampo_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_cedula(var_cedula, var_script_case_init, do_ajax_ver_tercero_mob_validate_cedula_cb);
  } // do_ajax_ver_tercero_mob_validate_cedula

  function do_ajax_ver_tercero_mob_validate_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cedula";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_cedula_cb

  // ---------- Validate eps
  function do_ajax_ver_tercero_mob_validate_eps()
  {
    var nomeCampo_eps = "eps";
    var var_eps = scAjaxGetFieldText(nomeCampo_eps);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_eps(var_eps, var_script_case_init, do_ajax_ver_tercero_mob_validate_eps_cb);
  } // do_ajax_ver_tercero_mob_validate_eps

  function do_ajax_ver_tercero_mob_validate_eps_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "eps";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_eps_cb

  // ---------- Validate antecedentes
  function do_ajax_ver_tercero_mob_validate_antecedentes()
  {
    var nomeCampo_antecedentes = "antecedentes";
    var var_antecedentes = scAjaxGetFieldSelectMult(nomeCampo_antecedentes, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_antecedentes(var_antecedentes, var_script_case_init, do_ajax_ver_tercero_mob_validate_antecedentes_cb);
  } // do_ajax_ver_tercero_mob_validate_antecedentes

  function do_ajax_ver_tercero_mob_validate_antecedentes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "antecedentes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_antecedentes_cb

  // ---------- Validate contacto
  function do_ajax_ver_tercero_mob_validate_contacto()
  {
    var nomeCampo_contacto = "contacto";
    var var_contacto = scAjaxGetFieldText(nomeCampo_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_contacto(var_contacto, var_script_case_init, do_ajax_ver_tercero_mob_validate_contacto_cb);
  } // do_ajax_ver_tercero_mob_validate_contacto

  function do_ajax_ver_tercero_mob_validate_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_contacto_cb

  // ---------- Validate telefono
  function do_ajax_ver_tercero_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_ver_tercero_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_ver_tercero_mob_validate_telefono_cb);
  } // do_ajax_ver_tercero_mob_validate_telefono

  function do_ajax_ver_tercero_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_ver_tercero_mob_validate_telefono_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_ver_tercero_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_ver_tercero_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logo = "";
    ...
    var var_eps = scAjaxGetFieldText("eps");
    var var_antecedentes = scAjaxGetFieldSelectMult("antecedentes", ";");
    ...
    scAjaxProcOn();
    x_ajax_ver_tercero_mob_submit_form(var_logo, var_nombres, var_cedula, var_eps, var_antecedentes, var_contacto, var_telefono, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_ver_tercero_mob_submit_form_cb);
  } // do_ajax_ver_tercero_mob_submit_form

  function do_ajax_ver_tercero_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_ver_tercero_mob_submit_form_cb_after_alert);
  } // do_ajax_ver_tercero_mob_submit_form_cb
  function do_ajax_ver_tercero_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_ver_tercero_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_ver_tercero_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_ver_tercero_mob_navigate_form, function() {});
    } else {
      perform_ajax_ver_tercero_mob_navigate_form();
    }
  }

  function perform_ajax_ver_tercero_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_ver_tercero_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['ver_tercero_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_ver_tercero_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_ver_tercero_mob_navigate_form_cb_after_alert);
  } // do_ajax_ver_tercero_mob_navigate_form_cb
  function do_ajax_ver_tercero_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_ver_tercero_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_ver_tercero_mob_navigate_form_cb_after_alert

  function sc_hide_ver_tercero_mob_form()
  {
  ...
  ajax_field_list[1] = "nombres";
  ajax_field_list[2] = "cedula";
  ajax_field_list[3] = "eps";
  ajax_field_list[4] = "antecedentes";
  ajax_field_list[5] = "contacto";
  ajax_field_list[6] = "telefono";
  ...
  var ajax_error_list = {
    ...
    "cedula": {"label": "CEDULA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "eps": {"label": "EPS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "antecedentes": {"label": "ANTECEDENTES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contacto": {"label": "CONTACTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["antecedentes"][1] = "antecedentes";
  ...
  var ajax_field_id = {
    ...
    "antecedentes": new Array("hidden_field_label_antecedentes", "hidden_field_data_antecedentes"),
