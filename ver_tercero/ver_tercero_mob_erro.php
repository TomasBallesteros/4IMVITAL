...
$old_error_handler = set_error_handler("ver_tercero_mob_scriptcase_error_handler");

function ver_tercero_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['ver_tercero_mob']['contr_erro']) && $_SESSION['scriptcase']['ver_tercero_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_ver_tercero_mob->contr_ver_tercero_mob->Apl_com_erro = true;
            if ($inicial_ver_tercero_mob->contr_ver_tercero_mob->NM_ajax_flag)
            {
                $inicial_ver_tercero_mob->contr_ver_tercero_mob->NM_ajax_info['errList']['geral_ver_tercero_mob'][] = $msg;
                return;
            }
            ver_tercero_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function ver_tercero_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['ver_tercero_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['ver_tercero_mob'])  ? $_SESSION['scriptcase']['error_icon']['ver_tercero_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['ver_tercero_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['ver_tercero_mob']) ? $_SESSION['scriptcase']['error_span_title']['ver_tercero_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['ver_tercero_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['ver_tercero_mob']) ? $_SESSION['scriptcase']['error_icon_title']['ver_tercero_mob'] : '';
?>
