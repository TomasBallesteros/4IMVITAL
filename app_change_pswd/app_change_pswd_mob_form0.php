...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags(""); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_title_change_pswd'] . " "); } ?></TITLE>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirm_pswd_line" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"> <span class="scFormLabelOddFormat css_confirm_pswd_label" style=""><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span></span><br>
