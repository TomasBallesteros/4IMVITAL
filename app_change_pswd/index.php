...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'Imvital', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['app_change_pswd']['glo_nm_conexao'], $this->root . $this->path_prod, 'Imvital', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    if (isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['app_change_pswd']['session_timeout']['lang'];
    }
    ...
    if (!isset($_SESSION['scriptcase']['app_change_pswd']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || $_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd'] != "on"))
    { 
        $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['app_change_pswd']['iframe_menu']) ? false : true;
